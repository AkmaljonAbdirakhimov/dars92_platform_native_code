...
class ShakePhone : FlutterPlugin, EventChannel.StreamHandler, SensorEventListener {
    private var CHANNEL = "uz.najottalim.platform/shake"
   ...
   // Plugin Flutter engine-ga biriktirilganda chaqiriladi
    override fun onAttachedToEngine(binding: FlutterPlugin.FlutterPluginBinding) {
        ...
        eventChannel = EventChannel(binding.binaryMessenger, CHANNEL)
